...
# 12 "pthread_cleanup.c"
   p1
# 12 "pthread_cleanup.c" 3 4
   ); int __not_first_call = __sigsetjmp ((struct __jmp_buf_tag *) (void *) __cancel_buf.__cancel_jmp_buf, 0); if (__builtin_expect ((__not_first_call), 0)) { __cancel_routine (__cancel_arg); __pthread_unwind_next (&__cancel_buf); } __pthread_register_cancel (&__cancel_buf); do {
# 12 "pthread_cleanup.c"
                                 ;
...
# 17 "pthread_cleanup.c" 3 4
   do { __pthread_unwind_buf_t __cancel_buf; void (*__cancel_routine) (void *) = (
# 17 "pthread_cleanup.c"
   func2
# 17 "pthread_cleanup.c" 3 4
   ); void *__cancel_arg = (
# 17 "pthread_cleanup.c"
...
int main(){
    pthread_t tid;
    pthread_create(&tid,
# 27 "pthread_cleanup.c" 3 4
                       ((void *)0)
# 27 "pthread_cleanup.c"
                           ,threadFunc,
# 27 "pthread_cleanup.c" 3 4
                                       ((void *)0)
# 27 "pthread_cleanup.c"
